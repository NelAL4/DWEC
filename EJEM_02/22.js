...
//No da error
console.log(alumno.examenes?.examen1)//si no existe no funciona, pero el programa no "rompe"
...
let numero 
const pagina = numero ?? 1 //si la constante esta vacia le asigno 1
console.log(pagina) //imprime 1